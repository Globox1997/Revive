...
import net.revive.item.ReviveItem;
...
public class ReviveMain implements ModInitializer {
    ...
    public static final ReviveItem REVIVE_ITEM = new ReviveItem(new Item.Settings().group(ItemGroup.MISC));
    ...
    public void onInitialize() {
        ...
        Registry.register(Registry.ITEM, new Identifier("revive", "revive_item"), REVIVE_ITEM);
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.CLERIC, 1, (factories -> {
            factories.add((entity, random) -> new TradeOffer(new ItemStack(Items.EMERALD, 7), new ItemStack(REVIVE_ITEM), 4, 1, 0.4F));
        }));
